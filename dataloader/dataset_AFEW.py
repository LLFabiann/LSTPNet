...
def train_data_loader():
    ...
    train_data = VideoDataset(list_file="D:/DL_Study/Expression_Project/Video_FER/Former-DFER-main-autodl/Former-DFER-main/annotation/AFEW_train.txt",
                              num_segments=8,
                              duration=2,
                              mode='train',
...
def test_data_loader():
    ...
    test_transform = torchvision.transforms.Compose([GroupResize(image_size),
                                                     Stack(),
                                                     ToTorchFormatTensor()])
    test_data = VideoDataset(list_file="D:/DL_Study/Expression_Project/Video_FER/Former-DFER-main-autodl/Former-DFER-main/annotation/AFEW_test.txt",
                             num_segments=8,
                             duration=2,
                             mode='test',
