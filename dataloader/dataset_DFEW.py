...
class VideoDataset(data.Dataset):
    ...
    def get_labels(self):
        self.target = [item.label for item in self.video_list]
        return self.target
    ...
    def get(self, record, indices):
        ...
        for seg_ind in indices:
            ...
            for i in range(self.duration):
                ...
                images_path.append(video_frames_path[p])
        ...
        return images, record.label, images_path
...
def train_data_loader(data_set):
    ...
    train_transforms = torchvision.transforms.Compose([
                                                    ...
                                                    #    GroupRandomSizedCrop(image_size),
                                                       ...
                                                       Stack(),
                                                       ToTorchFormatTensor(),
                                                    #    GroupRandomErasing(scale=(0.02, 0.1))
                                                       ])
    train_data = VideoDataset(list_file="/home/fabian/BRL/LCC/DL_Study/Expression_Project/Video_FER/Former-DFER-main-autodl/Former-DFER-main/annotation/DFEW_set_"+str(data_set)+"_train.txt",
                              num_segments=8,
                              duration=2,
                              mode='train',
...
def test_data_loader(data_set):
    ...
    test_data = VideoDataset(list_file="D:/DL_Study/Expression_Project/Video_FER/Former-DFER-main-autodl_6_1/Former-DFER-main/annotation/DFEW_set_"+str(data_set)+"_test.txt",
                             num_segments=8,
                             duration=2,
                             mode='test',
